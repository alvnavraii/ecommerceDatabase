...
public interface CategoryTranslationRepository extends JpaRepository<CategoryTranslation, Long> {
    @Query(value = "SELECT COUNT(*) FROM CATEGORY_TRANSLATIONS WHERE CATEGORY_ID = :categoryId AND LANGUAGE_ID = :languageId AND IS_ACTIVE = true", nativeQuery = true)
    ...
    @NonNull
    @Override
    @Query(value = "SELECT * FROM CATEGORY_TRANSLATIONS WHERE IS_ACTIVE = true ORDER BY CATEGORY_ID ASC, LANGUAGE_ID ASC", nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM CATEGORY_TRANSLATIONS WHERE CATEGORY_ID = :categoryId AND IS_ACTIVE = true ORDER BY LANGUAGE_ID ASC", nativeQuery = true)
    List<CategoryTranslation> findByCategoryId(Long categoryId);

    @Query(value = "SELECT * FROM CATEGORY_TRANSLATIONS WHERE LANGUAGE_ID = :languageId AND IS_ACTIVE = true ORDER BY CATEGORY_ID ASC", nativeQuery = true)
    List<CategoryTranslation> findByLanguageId(Long languageId);

    @Query(value = "SELECT * FROM CATEGORY_TRANSLATIONS WHERE CATEGORY_ID = :categoryId AND LANGUAGE_ID = :languageId AND IS_ACTIVE = true", nativeQuery = true)
